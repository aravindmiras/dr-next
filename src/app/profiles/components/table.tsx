...
export default function Table() {
  ...
  return (
    <div className="overflow-x-auto ">
      <p className="mx-9 mb-4 text-4xl font-bold text-gray-900 dark:text-white">Patient List</p>
  <table className="table">
    ...
    <tbody>
      ...
      <th>
       <a href={`/patient/${patient.id}`}> <button className="btn btn-ghost btn-xs">details</button> </a>
      </th>
    </tr>
      ))}
